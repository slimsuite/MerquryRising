...
settings = list(basefile="merquryrising",   # Prefix for output files (log and plots)
                config="tutorial.config",   # Name of the config file
                boundary="calculate",       # Whether to load or calculate boundaries
                merqurydir="tutorial",       # Directory containing merqury output files for processing
                ...
                labels="tutorial.fofn",     # FOFN with labels mapping on to histfiles
